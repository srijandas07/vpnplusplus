...
def get_parser1():
    ...
    parser.add_argument(
        '--config',
        default='/data/stars/user/sdas/PhD_work/poses_attention/PARS/config/smarthome-cross-subject/train_joint_new.yaml',
...
def get_parser2():
    ...
    parser.add_argument(
        '--config',
        default='/data/stars/user/sdas/PhD_work/poses_attention/PARS/config/smarthome-cross-subject/train_joint_new_cont.yaml',
        help='path to the configuration file')
